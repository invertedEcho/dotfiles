...
keys.desktopbuttons = gears.table.join( -- awful.button({ }, 1, sidepanel.toggle)
...
keys.globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Shift" }, "d", function()
		awful.spawn(apps.launcherext)
	end),
	awful.key({ modkey, "Shift" }, "c", function()
		awful.spawn(apps.roficalc)
	end),
	awful.key({ modkey }, "p", function()
		awful.spawn(apps.xrandr)
	end),
...
keys.clientkeys = gears.table.join(
	...
	end, { description = "focus next client (left)", group = "client" }),
	awful.key({ modkey }, "l", function()
		awful.client.focus.bydirection("right")
	end, { description = "focus next client (right)", group = "client" }),
	awful.key({ modkey }, "j", function()
		awful.client.focus.bydirection("down")
	end, { description = "focus next client (down)", group = "client" }),
	awful.key({ modkey }, "k", function()
		awful.client.focus.bydirection("up")
	end, { description = "focus next client (up)", group = "client" })
)
